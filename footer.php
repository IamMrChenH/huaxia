...
<!--侧边栏开始-->
<div class="sidebar"><!--购物车-->
<div class="shopcart" ><a href="/user/cart.php?uid=<?php echo $_REQUEST['uid']?>">
...
<div class="OfficialAccount" ><img src="/images/sidebar/OfficialAccount.png" ></div>
    <!--意见反馈-->
    <div><class="feedback" ><a href="/feedback.php"><img src="/images/sidebar/feedback.png" ></a></div>
    <!--回到顶部-->
...
<br><br><br><br><br><br><br><br>
        <div class="webinfo">
            ...
            <a  href="#" >帮助中心</a>|
            <a >设为主页</a>
            <a  href="#" >法律声明</a>|<a  href="" >隐私保护</a>|<a  href="#" >服务协议</a>|<a  href="/about/about.html" >关于我们</a>|<a  href="/contact_us.html" >联系我们</a>|            <a href="/admin/index.php" ><font >管理登录</font></a>
        </div>
