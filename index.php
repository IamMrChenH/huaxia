...
<body>
<!--活动屏开始-->
<img class="img1"src="images/20180916032933.png" style="position:absolute;top:100px;left:250px; z-index:999; opacity:0.95; display: none; ">
<!--活动屏结束-->
<!-- 顶部开始 -->
...
<div style="position: absolute; top: 0px;right: 100px; display: none;" >123</div>
<!-- 头部结束 -->
<!-- 主体开始 -->
<div class="container w1100">
  <div class="module cut module1">
    ...
    <div class="catebar w210 fl">
        <a href="http://wpa.qq.com/msgrd?v=3&uin=3259631096&site=qq&menu=yes" target="_blank">
            <img src="images/20180921202316.png" width="210" height="240" style="margin-top:10px"></a>    <!--<img src="images/aside.png"  width="210px"> --></div>
    <!-- 企业采购结束 -->
    <!-- 轮播图片广告开始 -->
    ...
    <div class="w240 fr cut">
      <div class="news mt10" style="height: 240px">
        ...
        ?>" class="fr">更多 <i>&gt;</i></a>最新资讯</h2>
                <ul>
                  <?php
                  $sql = "SELECT * FROM wenzhang limit 7";
                  $result = $conn->query($sql);
      ...
      <!--<img src="images/aside2.png" width="240" height="43" style="margin:0px; padding:0px; clear:both">-->
      <!-- 广告位(240x70)结束 -->
    </div>
    <!-- 资讯结束 -->
  </div>
